 ...
 * 声卡效果页面
 */
public class SoundCardFragment extends BaseFragment implements NetworkHelper.OnNetworkEventCallback, NetworkStateHelper.Listener, ProductCacheManager.OnUpdateListener {
