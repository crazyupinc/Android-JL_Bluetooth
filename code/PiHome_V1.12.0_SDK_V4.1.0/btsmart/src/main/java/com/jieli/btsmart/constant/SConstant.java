...
public class SConstant {
    ...
    public static final String KEY_RESOURCE_MESSAGE = "key_resource_message";
    ...
    //是否使用保存log文件
    public final static boolean IS_USE_SAVE_LOG = false;
    //是否使用BLE通讯
    public final static boolean IS_USE_BLE_WAY = false;
    ...
    public final static String KEY_USE_SAVE_LOG = "use_save_log";
     ...
     * 资源文件夹
     */
    public final static String DIR_RESOURCE = "resource";
    /**
     * 彩屏充电仓文件夹
     */
    public final static String DIR_CHARGING_CASE = "charging_case";
    /**
     * 开机动画文件夹
     */
    public final static String DIR_BOOT = "boot";
    /**
     * 屏幕保护程序文件夹
     */
    public final static String DIR_SCREEN = "screen";
    /**
     * 屏保锁屏文件夹
     * <p>屏幕保护程序文件夹的子文件</p>
     */
    public final static String DIR_LOCK = "lock";
    /**
     * 屏保解锁文件夹
     * <p>屏幕保护程序文件夹的子文件</p>
     */
    public final static String DIR_UNLOCK = "unlock";
    /**
     * 自定义屏保文件夹
     * <p>屏幕保护程序文件夹的子文件</p>
     */
    public final static String DIR_CUSTOM = "custom";
    /**
     * 自定义屏保转码输出文件夹
     * <p>屏幕保护程序文件夹的子文件</p>
     */
    public final static String DIR_OUTPUT = "output";
    /**
     * 墙纸文件夹
     */
    public final static String DIR_WALLPAPER = "wallpaper";
    ...
    public final static String ACTION_USING_RESOURCE_CHANGE = "com.jieli.btsmart.using_resource_change";
    public final static String ACTION_DEVICE_SETTINGS_CHANGE = "com.jieli.btsmart.device_settings_change";
