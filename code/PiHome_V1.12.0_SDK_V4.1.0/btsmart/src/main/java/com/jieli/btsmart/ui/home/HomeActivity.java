...
import com.jieli.btsmart.ui.base.NetworkActivity;
...
//            System.exit(0);
    ...
    public void onPostNotificationPermissionNeverAsk() {
        showTips("%s%s", getString(R.string.permissions_tips_02), getString(R.string.permission));
    }
    ...
    private void initUI() {
       ...
       /* int mediaPlayMode = PreferencesHelper.getSharedPreferences(this).getInt(KEY_MEDIA_PLAY_MODE, -1);
        ...
        shakeItManager.getOnShakeItStartLiveData().observeForever(mode -> {
            if (mode == JLShakeItManager.SHAKE_IT_MODE_CUT_SONG && mViewModel.isDevConnected()) {
