...
public class LocationHelper {
            ...
            synchronized (LocationHelper.class) {
                if (null == instance) {
                    try {
                        ...
                        JL_Log.e(TAG, "getInstance", "Exception : " + e.getMessage());
                    }
                }
            }
        }
    ...
    private void registerReceiver() {
        if (mReceiver == null) {
            ...
            MainApplication.getApplication().registerReceiver(mReceiver, intentFilter);
        }
    }
    ...
    private final AMapLocationListener mMapLocationListener = new AMapLocationListener() {
        ...
        public void onLocationChanged(AMapLocation aMapLocation) {
            ...
            if (aMapLocation.getErrorCode() == 0) {
                JL_Log.v(TAG, "onLocationChanged", aMapLocation.toStr());
