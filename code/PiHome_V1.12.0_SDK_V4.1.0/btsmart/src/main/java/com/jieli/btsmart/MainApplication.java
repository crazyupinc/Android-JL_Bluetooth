...
public class MainApplication extends Application {
    ...
    public void init() {
        ...
        boolean isLog = PreferencesHelper.getSharedPreferences(MainApplication.getApplication())
                .getBoolean(SConstant.KEY_USE_SAVE_LOG, BuildConfig.DEBUG ? true : SConstant.IS_USE_SAVE_LOG);
...
//        com.jieli.jl_bt_ota.util.JL_Log.setIsSaveLogFile(getApplicationContext(), isSaveLog);
    ...
    public static void privacyPolicyAgreed() {
        ...
        try {
            ...
            JL_Log.d("ZHM", "privacyPolicyAgreed", "id : " + OAID);
